...
- **③ Multiple Graphs**: these graphs are based on [ClickHouse built-in advanced monitoring dashboards](https://clickhouse.com/docs/operations/system-tables/dashboards). ClickLens selects metrics following the [ClickHouse operations documentation](https://clickhouse.com/docs/operations/monitoring).
